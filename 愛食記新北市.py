...
tmpData = list()
page = 1
url= "https://ifoodie.tw/explore/%E6%96%B0%E5%8C%97%E5%B8%82/list?page={}".format(page)
...
for Page1 in range(1,68):
    ...
    for j, i in enumerate(ifoodie_html.select('a[target="_self"]')):
        if j % 3 == 0:
            ...
            try:
                ...
                # print(comments['name'])
                # print(comments['address']['streetAddress'])
                tmpstr = list()
    ...
    url = "https://ifoodie.tw/explore/%E6%96%B0%E5%8C%97%E5%B8%82/list?page={}".format(Page1)
    print(Page1)
